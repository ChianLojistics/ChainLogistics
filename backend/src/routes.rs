...
fn public_api_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/storage/anchors/:product_id", get(crate::handlers::storage::list_product_anchors))
        .route("/storage/anchors/detail/:id", get(crate::handlers::storage::get_anchor))
        .route("/storage/alerts", get(crate::handlers::storage::list_tamper_alerts))
...
fn admin_api_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/recalls", post(crate::handlers::recall::create_recall)
            .layer(middleware::from_fn(require_role(vec![UserRole::Inspector, UserRole::Administrator]))))
        .route("/recalls/:id/notify", post(crate::handlers::recall::notify_recall)
            .layer(middleware::from_fn(require_role(vec![UserRole::Inspector, UserRole::Administrator]))))
        .route("/recalls/:id/effectiveness", post(crate::handlers::recall::update_effectiveness)
            .layer(middleware::from_fn(require_role(vec![UserRole::Inspector, UserRole::Administrator]))))
        ...
        .route("/financing/request", post(crate::handlers::financial::request_financing)
            .layer(middleware::from_fn(require_role(vec![UserRole::Supplier, UserRole::Administrator]))))
        .route("/storage/anchors", post(crate::handlers::storage::register_anchor))
        .route("/storage/verify", post(crate::handlers::storage::run_verification))
        .route("/storage/anchors/:id/verify", post(crate::handlers::storage::verify_anchor))
