...
impl AnalyticsService {
    ...
    pub async fn get_dashboard_metrics(&self) -> Result<DashboardMetrics, AppError> {
        ...
        let top_categories: Vec<CategoryCount> = category_rows
            ...
            .map(|r| CategoryCount {
                ...
                active_count: r.get::<Option<i64>, _>("active_count").unwrap_or(0),
            })
            .collect();
    ...
    pub async fn get_product_analytics(
        ...
        let product_first_event_at: Option<DateTime<Utc>> = product_row.get("first_event_at");
    ...
    pub async fn get_event_analytics(
        ...
        let total_row = sqlx::query(
            "SELECT COUNT(*) AS count FROM tracking_events WHERE timestamp BETWEEN $1 AND $1",
        )
        .bind(start)
        .bind(end)
        .fetch_one(&self.pool)
        .await?;
        let total_events = total_row.get::<Option<i64>, _>("count").unwrap_or(0);
        ...
        let most_active_products: Vec<ProductEventCount> = active_rows
            ...
            .map(|r| ProductEventCount {
                ...
                event_count: r.get::<Option<i64>, _>("event_count").unwrap_or(0),
            })
            .collect();
        ...
        let data_rows: Vec<Vec<String>> = rows
            ...
            .map(|r| {
                vec![
                    ...
                    crate::utils::aggregation::csv_escape(&r.get::<String, _>("product_name")),
                    r.get::<String, _>("actor_address"),
