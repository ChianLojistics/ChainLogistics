  ...
  return [
    {
      ...
      owner,
      createdAt: Math.floor((now - 30 * dayMs) / 1000),
      active: true,
      category: "Beverages",
    ...
    },
    {
      ...
      owner,
      createdAt: Math.floor((now - 15 * dayMs) / 1000),
      active: true,
      category: "Produce",
      tags: ["organic", "fresh"],
      eventCount: 3,
    },
    {
      ...
      owner,
      createdAt: Math.floor((now - 7 * dayMs) / 1000),
      active: true,
      category: "Apparel",
    ...
    },
    {
      ...
      owner,
      createdAt: Math.floor((now - 45 * dayMs) / 1000),
      active: false,
      category: "Food",
      tags: ["raw", "local"],
      eventCount: 12,
